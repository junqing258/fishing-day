...
(function() {
    ...
    var AnimationTemplet = laya.ani.AnimationTemplet,
    ...
    var DBAnimationData = (function() {
        ...
        __proto.initData = function(data, armatureData) {
            ...
            for (i = 0; i < tFrameArr.length; i++) {
                ...
                tDBFrameData.event = tFrameData.event || tFrameData.events;
            ...
            for (i = 0; i < tMergeFrameData.mFrameDataList.length; i++) {
                ...
                if ((tDBFrameData.event instanceof Array)) {
                    var tEventList = tDBFrameData.event;
                    var eventI = 0,
                        eventLen = 0;
                    eventLen = tEventList.length;
                    var tEventO;
                    for (eventI = 0; eventI < eventLen; eventI++) {
                        tEventO = tEventList[eventI];
                        tEventData = new EventData();
                        tEventData.name = tEventO.name;
                        tEventData.time = tDBFrameData.time;
                        this.getEventDataByEventO(tEventO, tEventData);
        ...
        __proto.getEventDataByEventO = function(tEventO, tEventData) {
            if (tEventO.ints && tEventO.ints[0]) {
                tEventData.intValue = parseInt(tEventO.ints[0]);
            }
            if (tEventO.floats && tEventO.floats[0]) {
                tEventData.floatValue = parseFloat(tEventO.floats[0]);
            }
            if (tEventO.strings && tEventO.strings[0]) {
                tEventData.stringValue = tEventO.strings[0];
            }
        }
    ...
    var SpineAniFrames = (function() {
        ...
        __proto.createFrame2 = function(preFrame, nextFrame, time) {
            ...
            } else if (curve == "stepped") {} else if ((curve instanceof Array)) {
                var curveArr;
                curveArr = curve;
                var newCurve = [];
                var i = 0,
        ...
        __static(SpineAniFrames, ['FrameInterval', function() {
            return this.FrameInterval = 1 / 30;
        }]);
        ...
        __proto.init = function(textureMap, data) {
            ...
            while (true) {
                ...
                if (line.length == 0) {
                    ...
                    page.uWrap = 0;
                    page.vWrap = 0;
                    if (direction == "x") {} else if (direction == "y") {} else if (direction == "xy") {};
    ...
    var BoneAniDataNew = (function() {
        ...
        __static(BoneAniDataNew, ['Keys', function() {
            return this.Keys = ["rotate", "translate", "scale", "shear"];
        }]);
    ...
    var SpineFileAdpter = (function() {
        ...
        __static(SpineFileAdpter, ['I', function() {
            return this.I = new SpineFileAdpter();
        }, 'BoneKeysST', function() {
            return this.BoneKeysST = ["x", "y", "rotation", "scaleX", "scaleY", "shearX", "shearY"];
            ...
            return this.BoneKeys = ["rotate", "translate", "scale", "shear"];
    ...
    var testTools = (function() {
        function testTools() {
            ...
            this.DBFileName = "ytj";
            this.DBFileName = "hou";
            this.DBFileName = "mao_phase1_20170307";
            this.mTools = new BoneAniTools();
            ...
            this.DBFileName = "TestRo";
            this.DBFileName = "mao_phase1_20170307";
            this.DBFileName = "heguan_ske";
            this.DBFileName = "draworder";
            this.DBFileName = "game_CXDDD";
            this.DBFileName = "fangtianhuaji";
            this.DBFileName = "Dragon";
                        ...
                        for (j = 0; j < tSkinArray.length; j++) {
                            ...
                            for (l = 0; l < tMySkinData.slotArr.length; l++) {
                                ...
                                for (k = 0; k < tDBSlotData.displayArr.length; k++) {
                                    ...
                                    tDBTextureData = null;
                                    if (tDBSkinSlotDisplayData.path) {
                                        tDBTextureData = this.mDBTextureDataDic[tDBSkinSlotDisplayData.path];
                                    }
                                    if (!tDBTextureData)
            ...
            if (drawOrderValues) {
                ...
                for (var $each_drawOrderMap in drawOrderValues) {
                    ...
                    if (drawOrderMap["zOrder"]) {
                        ...
                        tDOAniData.time = (frameIndex) * onFrameTime;
        ...
        __proto.computeWorldVertices2 = function(slot, start, count, worldVertices, offset) {
            ...
            if (bones == null) {
                ...
                var a = bone.resultMatrix.a,
                    b = bone.resultMatrix.b,
                    c = bone.resultMatrix.c,
